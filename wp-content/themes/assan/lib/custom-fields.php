...
$assan_meta_boxes = array("_assan_page_layout" => array(
    ...
    "_assan_rev_slider" => array(
        ...
        "description" => __('Select Revolution slider on theme Theme Slider and Choose between existing Revolution Slider.', 'assan'),
        "type" => "rev_slider",
        "location" => "Page"
    ),
    //POST
    ...
    "_assan_portfolio_rev_slider" => array(
        "name" => "_assan_rev_slider",
        "title" => "Revolution Slider ",
    ...
    //PRODUCT
    "_assan_product_slider" => array(
        "name" => "_assan_slider",
        "title" => "轮播插件",
        "description" => "请先在上面选择Banner需要的轮播插件。",
        "type" => "select",
        "options" => array(
            array("value" => "", "text" => "请选择轮播插件"),
            // array("value" => "flex", "text" => "Flex Slider"),
            // array("value" => "carousel", "text" => "Carousel Slide"),
            array("value" => "revolution", "text" => "Revolution Slider")
        ),
    ...
    "_assan_product_rev_slider" => array(
        "name" => "_assan_rev_slider",
        "title" => "Revolution Slider ",
        "description" => "请从Revolution slider中选择一个作为本页面的Banner。",
        "type" => "rev_slider",
        "location" => "product"
    ),
    //ONE PAGE SECTION
...
function assan_meta_boxes_page() {
    assan_new_meta_boxes('Page');
}

function assan_meta_boxes_post() {
    assan_new_meta_boxes('post');
}

function assan_meta_boxes_portfolio() {
    assan_new_meta_boxes('portfolio');
}

function assan_meta_boxes_onepage() {
    assan_new_meta_boxes('OnePage');
}

function assan_meta_boxes_product() {
    assan_new_meta_boxes('product');
}

function assan_new_meta_boxes($type) {
...
// Use nonce for verification
    ...
    function create_meta_box() {
        ...
        if (function_exists('add_meta_box')) {
            add_meta_box('assan_meta_boxes_page', $themename . ' Theme Page Settings', 'assan_meta_boxes_page', 'page', 'normal', 'high');
            add_meta_box('assan_meta_boxes_post', $themename . ' Theme Post Settings', 'assan_meta_boxes_post', 'post', 'normal', 'high');
            add_meta_box('assan_meta_boxes_portfolio', $themename . ' Theme Portfolio Settings', 'assan_meta_boxes_portfolio', 'portfolio', 'normal', 'high');
            add_meta_box('assan_meta_boxes_onepage', $themename . ' Theme One Page Settings', 'assan_meta_boxes_onepage', 'onepage', 'normal', 'high');
            add_meta_box('assan_meta_boxes_product', __('Binary Go Web Plugin Product Settings', 'assan'), 'assan_meta_boxes_product', 'product', 'normal', 'high');
        }
    }
