<?php
/* * *******************RECENT PORTFOLIO************************* */
class assan_Portfolio_widget extends WP_Widget {

    function __construct() {
        parent::__construct('assan_Portfolio', 'Crazy Portfolio', array('description' => 'Recent Portfolio'));
    }
    ...
    function widget($args, $instance) {
        ...
        if ($portfolios->have_posts()) :
            ...
            while ($portfolios->have_posts()) : $portfolios->the_post();
                if ($display_count < $portfolio_number && $post->post_content) {
...
class assan_Social_Widgets extends WP_Widget {

    function __construct() {
        parent::__construct('assan_social_share', 'Crazy Share Button', array('description' => 'Social Share Buttons'));
    }
