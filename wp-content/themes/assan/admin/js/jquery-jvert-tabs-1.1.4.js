...
(function($) {
	...
	$.fn.jVertTabs = function(attr,options) {
        ...
        return this.each(function() {
			...
			var tabColumn = tabRoot.children("div.assan_tabs-column");

			var tabContentColumn = tabRoot.children("div.assan_tabs-content-column");
			...
			$(this).find(".assan_tabs-column > ul > li").each(function(i){
			...
			$(this).children(".assan_tabs-content-column > div.assan_tabs-content-panel").each(function(i){
		...
		function handleTabClick(li,liIndex,tabRoot,doSelectedCallBack){
			...
			var tabCol = tabRoot.children("div.assan_tabs-column");

			var tabContentCol = tabRoot.children("div.assan_tabs-content-column");
			...
			tabContentCol.children("div.assan_tabs-content-panel").each(function(i){
		...
		function getTotalTabsHeight(tabRoot){
			...
			tabRoot.find(".assan_tabs-column > ul > li").each(function(i){
		 ...
		 * tabContentCol - reference to the #assan_tabs-content-column element
		...
		function setStyle(tabRoot){
			...
			tabRoot.addClass("assan_tabs");

			tabRoot.children("div").eq(0).addClass("assan_tabs-column");

			tabRoot.children("div").eq(1).addClass("assan_tabs-content-column");

			tabRoot.children("div").eq(1).children("div").addClass("assan_tabs-content-panel");
		...
		function adjustMargin(tabRoot){			
			...
			$(tabRoot).children('div.assan_tabs-content-column').css({"margin-left": tabColWidth-1 + "px"});
